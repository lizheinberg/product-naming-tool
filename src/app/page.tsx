...
function ResultsScreen({
  ...
  const riskColor =
    outcome.riskLevel === "high"
      ? "var(--high)"
      : outcome.riskLevel === "moderate"
        ? "var(--warning)"
        : "var(--success)";
  const riskBg =
    outcome.riskLevel === "high"
  ...
  const statusColor = (status: "clear" | "caution" | "risk") =>
    status === "risk"
      ? "var(--high)"
      : status === "caution"
        ? "var(--warning)"
    ...
    <div className="animate-fade-in">
            ...
            >
              <div
                style={{
                  ...
                  height: 10,
                  borderRadius: "50%",
                  background: statusColor(factor.status),
                  marginTop: 5,
                  flexShrink: 0,
                }}
              />
      ...
      {outcome.riskLevel !== "low" && (
        ...
        >
          ...
          >
            {outcome.riskLevel === "high"
              ? "Ready to explore a new holdco name?"
              : "Need help addressing these issues?"}
          </h3>
          <p
            style={{
              fontSize: 15,
